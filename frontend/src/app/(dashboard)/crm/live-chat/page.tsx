...
// // ---------- Types ----------
// export type ChannelFilter = "all" | "whatsapp" | "instagram" | "rcs" | "facebook";
...
//     lastMessage: "Thanks for configuring the WhatsApp green badge verification.",
...
//             <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-medium bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
...
//                       matching.length > 0 &&
//                       (!activeConversation ||
//                         (tab.id !== "all" && activeConversation.channel !== tab.id))
//                     ) {
...
//           <div className="hidden sm:flex items-center gap-1 shrink-0 text-xs text-muted-foreground pr-2">
//             <span>Filtering:</span>
...
//         {/* ==================================================== */}
//         <div className="w-full sm:w-80 md:w-88 flex flex-col border-r shrink-0 bg-card">
...
//                 className="pl-8.5 h-8.5 text-xs bg-muted/30"
//               />
//               {searchQuery && (
//                 <button
...
//                 <p className="text-xs">
//                   No {selectedChannel !== "all" ? selectedChannel : ""} chats match
...
//                       isSelected
//                         ? "bg-accent/70 border-l-3 border-primary"
//                         : "hover:bg-muted/40"
//                     )}
//                   >
...
//                       <div
//                         className={cn(
//                           "absolute -bottom-1 -right-1 h-4.5 w-4.5 rounded-full flex items-center justify-center ring-2 ring-card shadow-xs",
//                           meta.iconStyle
//                         )}
//                         title={meta.name}
//                       >
...
//                           variant="outline"
//                           className={cn(
//                             "text-[10px] px-1.5 py-0 font-medium h-4.5 gap-1",
//                             meta.badgeStyle
//                           )}
//                         >
//                           <ChannelIcon className="h-2.5 w-2.5" />
...
//             {/* Conversation Header */}
//             <div className="flex items-center justify-between p-3.5 border-b bg-card shrink-0">
...
//                       variant="outline"
//                       className={cn(
//                         "text-[10px] px-1.5 py-0 h-4.5 gap-1",
...
//                 <span className="text-[11px] bg-muted/60 text-muted-foreground px-3 py-1 rounded-full font-medium">
//                   Chat initiated via {channelMeta[activeConversation.channel].name}
//                 </span>
//               </div>
...
//                   <Input
//                     placeholder={`Message ${activeConversation.name} on ${
//                       channelMeta[activeConversation.channel].name
//                     }... (Press Enter to send)`}
//                     value={inputMessage}
//                     onChange={(e) => setInputMessage(e.target.value)}
//                     className="h-9.5 text-xs bg-muted/20 pr-9"
//                   />
//                   <button
//                     type="button"
//                     className="absolute right-2.5 top-2.5 text-muted-foreground hover:text-foreground"
...
//                   className="h-9.5 px-3.5 bg-primary text-primary-foreground shrink-0 gap-1.5 text-xs"
//                 >
...
//                 </span>
//                 <span className="text-[10px]">Shift + Enter for new line</span>
//               </div>
//             </div>
//           </div>
//         ) : (
...
//               Select a conversation from the left to start live multi-channel chat.
//             </p>
//           </div>
//         )}
...
//           <div className="hidden lg:flex w-72 flex-col border-l bg-card shrink-0 p-4 space-y-4 overflow-y-auto">
...
export default function LiveChatPage() {
  ...
  useEffect(() => {
    ...
    setNameDraft(activeConversation ? customNames[activeConversation.id] || "" : "");
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-medium bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300 whitespace-nowrap">
              ...
              <span className="hidden sm:inline">Realtime Multi-Channel Online</span>
              ...
              <div className="w-full">
                {isEditingName ? (
                  ...
                  >
                    ...
                    />
                    <Button type="submit" size="sm" className="h-8 px-2.5 text-[11px] shrink-0">
                      Save
                    </Button>
                    <Button
                      type="button"
                  ...
                  <>
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setNameDraft(customNames[activeConversation.id] || "");
