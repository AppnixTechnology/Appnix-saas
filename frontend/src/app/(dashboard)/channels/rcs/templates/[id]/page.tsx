...
import { RCSTemplateDetailView } from "@/components/rcs-templates/RCSTemplateDetailView";
import { Button } from "@/components/ui/button";
import { ArrowLeft, Loader2 } from "lucide-react";
import Link from "next/link";

export default function RCSTemplateDetailPage() {
  ...
  return <RCSTemplateDetailView template={template} />;
}
