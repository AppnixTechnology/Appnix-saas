...
const channels = [
  ...
  { icon: Instagram, name: "Instagram Direct", description: "Manage Instagram DMs, comments, and story replies from unified inbox", color: "text-pink-600 bg-pink-50" },
  { icon: Facebook, name: "Facebook Messenger", description: "Connect Facebook Pages and manage Messenger conversations at scale", color: "text-blue-700 bg-blue-50" },
];
